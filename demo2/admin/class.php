...
$sql = "select * from class order by cid desc limit ".$start_page.",".$end_page ;
    ...
    <div class="main">
        <div class="main_left">
            <ul>
                ...
                <li class="active"><a href="class.php">分类</a></li>
        ...
        <div class="main_right">
            <div class="main_top">
                ...
                <div class="part">
                    <p style="margin-top: 20px;margin-left: 100px;margin-bottom: 20px;font-size: 20px"><a href="add_tag.php?type=class">添加分类</a></p>
                </div>
                <div class="clear"></div>
                ...
                <div class="part">
                    <table style="width: 85%;min-width: 1000px;margin-left: 50px;text-align: center">
                        ...
                        while ($row = mysqli_fetch_array($res)){
                            ...
                            echo "  <td height='40px'>".$row[cname]."</td>";
                            echo "  <td height='40px'>".$row[crename]."</td>";
                            echo "  <td height='40px'>".$row[cfaname]."</td>";
                            echo "  <td height='40px'>".$row[cdate]."</td>";
                            echo " <td height='40px'><a href='rw_tag.php?type=class&&id=".$row[cid]."'>修改</a> </td>" ;
                            echo " <td height='40px'><a href='deal/del_class.php?type=class&&id=".$row[cid]."' >删除</a></td>" ;
                            echo "</tr>";
