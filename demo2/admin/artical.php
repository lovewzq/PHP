    ...
    <div class="main">
        ...
        <div class="main_right">
            <div class="main_top">
                ...
                <div class="part">
                    <p style="margin-top: 20px;margin-left: 100px;margin-bottom: 20px;font-size: 20px"><a href="add_article.php">添加文章</a></p>
                </div>
                <div class="clear"></div>
                ...
                <div class="part">
                    <table style="width: 85%;min-width: 1000px;margin-left: 50px;text-align: center">
                        ...
                        while ($row = mysqli_fetch_array($res)){
                         ...
                         echo "  <td height='40px'>".$row[atitle]."</td>";
                         echo "  <td height='40px'>".$row[aclass]."</td>";
                         echo "  <td height='40px'>".$row[atag]."</td>";
                         echo "  <td height='40px'>".$row[comment]."</td>";
                         echo "  <td height='40px'>".$row[date]."</td>";
                         echo " <td height='40px'><a href='rw_artical.php?id=".$row[aid]."'>修改</a> </td>" ;
                         echo " <td height='40px'><a href='deal/del.php?id=".$row[aid]."' >删除</a></td>" ;
                        echo "</tr>";
            ...
            <div class="main_foot">
                ...
                <ul class="pagination" style="margin-top: 50px;position: absolute;right: 100px;">
                    ...
                    <li><a href="<?php
                        if($page>2){
                            echo "artical.php?page=".($page-1);
                        }
                        ?>">«</a></li>
                    <?php
                    for($i=1;$i<=$N;$i++){
                        if($i==$page){
                            echo '<li><a class="active" href="artical.php?page='.$page.'">'.$page.'</a></li>';
                        }else{
                            echo '<li><a href="artical.php?page='.$i.'">'.$i.'</a></li>';
                        }
                    }
                    ?>
                    <li><a href="<?php
